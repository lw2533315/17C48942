...
/*  链表检测小代码
 */
//       cout<<"test list table~~~~~~~~~~~~~~~~~~~"<<endl;
//     for(int i=0;i<nodeNum;i++){
//         cout<<"headNode is "<<i+1<<endl;
//         cout<<p[i].nodeName;
//         arcNode* tt=p[i].link;
//         while(tt){
//             cout<<"target node is "<<tt->desVertex+1<<" ";
//                tt=tt->next;     
//         }
//         cout<<endl;
//    }
...
//     for(int i=0;i<nodeNum;i++){
////         cout<<"headNode is "<<i+1<<endl;
////         cout<<headTemp[i].nodeName;
//         arcNode* tt=headTemp[i].link->next;
//         while(tt){
//             cout<<"target node is "<<tt->desVertex+1<<" ";
//                tt=tt->next;     
//         }
